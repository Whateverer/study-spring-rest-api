...
public class EventControllerTests extends BaseControllerTest {
    ...
    public void createEvent() throws Exception {
        ...
        mockMvc.perform(post("/api/events/") // perform 안에 주는 것 == 요청
                        .header(HttpHeaders.AUTHORIZATION, getBearerToken())
                        .contentType(MediaType.APPLICATION_JSON_VALUE)
                        .accept(MediaTypes.HAL_JSON)
                        .content(objectMapper.writeValueAsString(event)))
                .andDo(print())
                .andExpect(status().isCreated()) // is(원하는 요청)
                ...
                .andDo(document("create-event", // 처음 주는 인자값 : 이 문서의 이름, 뒤의 스니펫
                        links(
    ...
    private String getAccessToken() throws Exception{
        ...
        return parser.parseMap(requestBody).get("access_token").toString();
    }
    ...
    public void createEvent_Bad_Request() throws Exception {
        ...
        mockMvc.perform(post("/api/events/")
                        ...
                        .content(objectMapper.writeValueAsString(event)))
                .andDo(print())
                .andExpect(status().isBadRequest()) // is(원하는 요청)
                ;
    }
